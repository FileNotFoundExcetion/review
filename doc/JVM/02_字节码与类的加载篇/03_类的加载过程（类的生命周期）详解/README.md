...
![image-20210430215050746](images/b73db20eea59665fa3de67e1dec6d4e5.png)

其中，验证、准备、解析 3 个部分统称为链接（Linking）

从程序中类的使用过程看

![image-20210430215236716](images/c6e5a63339bb2574b9b52a9ed14ee9c5.png)
...
![image-20210430221037898](images/10969de50477655b954b23bfe550fb1d.png)
...
- 如果数组的元素类型是引用类型，那么久遵循定义的加载过程递归加载过程和创建数组A的元素类型；
...
![image-20210430221736546](images/2309ce7d4bdbffb86ae462e967af5dc9.png)
...
![image-20210430225015932](images/b223d288b413f0ed0732357023a1dc7e.png)
...
![image-20210430235455086](images/5aaa031ab1ffc8071fb92a32ead888ef.png)
